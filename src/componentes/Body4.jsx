...
<p  className="textao2">Na Academia BAI, cada detalhe é cuidadosamente planeado para garantir o máximo conforto, <br/> funcionalidade e sucesso para o seu evento. Seja qual for a ocasião, estamos prontos para <br/> oferecer o melhor espaço e os melhores serviços. Venha conhecer e realizar o seu evento <br/>connosco! </p>
